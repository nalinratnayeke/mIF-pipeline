...
- `instanseg_runner.py`: medium-image InstanSeg wrapper that writes full-resolution uint32 mask TIFFs directly
...
- The segmentation handoff chain is:
  `seg_merge.ome.tif` -> InstanSeg medium inference -> direct mask TIFFs -> Nimbus
